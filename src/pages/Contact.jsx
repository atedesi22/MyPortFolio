        ...
        <>
            <div id='contact'>
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <a href="/CV_Atedesi.pdf" download className="inline-flex items-center gap-2 bg-slate-800 hover:bg-slate-700 active:bg-slate-700 text-white w-fit px-6 py-3 rounded-4xl transition-all">
