    ...
    <section className="relative h-screen flex flex-col justify-center items-center bg-slate-900 text-white overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
          ...
          <a href="/cv_atedesi.pdf" className="px-8 py-4 border border-slate-700 hover:bg-slate-800 active:bg-slate-800 rounded-4xl font-semibold transition-all" download>
            Télécharger mon CV
          </a>
        </div>
      </motion.div>
